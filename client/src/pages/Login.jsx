            ...
            <form action="#" className="mt-8 grid grid-cols-6 gap-6">
              <div className="col-span-6">
                ...
                <input
                  ...
                  id="Email"
                  name="email"
                  className="mt-1 w-full h-12 rounded-md border-gray-600 outline outline-blue-400 bg-white text-md text-gray-700 shadow-gray-600 shadow-md"
                />
              </div>
              ...
              <div className="col-span-6 sm:flex sm:items-center text-center">
